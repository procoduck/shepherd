...
var _ = Describe("Renderer — D1 direction", func() {
	...
	It("renders both directions of a real metrics pipeline from the shipped artifact", func() {
		...
		Expect(r.Content).To(Equal(
			"// generated by shepherd visual builder — do not edit by hand (edits will be overwritten); graph revision 3, schema " + strings.TrimPrefix(version.AlloySchemaVersion, "alloy-") + "\n" +
