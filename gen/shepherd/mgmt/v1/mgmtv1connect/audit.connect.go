...
const (
	...
	AuditServiceName = "shepherd.mgmt.v1.AuditService"
)
...
const (
	...
	AuditServiceListAuditProcedure = "/shepherd.mgmt.v1.AuditService/ListAudit"
)

// AuditServiceClient is a client for the shepherd.mgmt.v1.AuditService service.
type AuditServiceClient interface {
	ListAudit(context.Context, *connect.Request[v1.ListAuditRequest]) (*connect.Response[v1.ListAuditResponse], error)
}

// NewAuditServiceClient constructs a client for the shepherd.mgmt.v1.AuditService service. By
...
func NewAuditServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuditServiceClient {
	...
	auditServiceMethods := v1.File_shepherd_mgmt_v1_audit_proto.Services().ByName("AuditService").Methods()
...
// ListAudit calls shepherd.mgmt.v1.AuditService.ListAudit.
...
// AuditServiceHandler is an implementation of the shepherd.mgmt.v1.AuditService service.
...
func NewAuditServiceHandler(svc AuditServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/shepherd.mgmt.v1.AuditService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuditServiceHandler) ListAudit(context.Context, *connect.Request[v1.ListAuditRequest]) (*connect.Response[v1.ListAuditResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("shepherd.mgmt.v1.AuditService.ListAudit is not implemented"))
}
