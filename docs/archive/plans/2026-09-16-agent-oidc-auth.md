> **Archived — shipped in v0.8.0 / chart 0.12.0 (2026-09-16).** The feature (verifier, store+CLI,
> gate+enforcement, beacon, chart values, admin RPC+UI, e2e proof) merged across PRs #84–#95. The
> deferred *mode 2* (IdP-authoritative org) is tracked on the board as issue #113. This is the
> original design record, kept verbatim.
